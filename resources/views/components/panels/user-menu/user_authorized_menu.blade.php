<nav class="flex sm:justify-end sm:items-center flex-col sm:flex-row space-y-2 md:space-y-0 sm:space-x-8 text-sm">
    <a class="text-gray-500 hover:text-orange flex items-center space-x-1" href="#">
    ...
    <a class="text-gray-500 hover:text-orange flex items-center space-x-1" href="{{route('admin')}}">
