...
@section('template-content')
    ...
    <section class="news-block-inverse px-4 py-4">
        <div>
            ...
            <span class="inline-block text-gray-200 pl-1"> / <a href="../../../../../Desktop/grade_layout/news.html"
        ...
        <div class="grid md:grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="w-full flex">
                <div class="h-48 lg:h-auto w-32 sm:w-60 lg:w-32 xl:w-48 flex-none text-center overflow-hidden">
                    <a class="block w-full h-full hover:opacity-75"
                       href="../../../../../Desktop/grade_layout/article.html"><img src="/assets/pictures/car_ceed.png"
                ...
                <div class="px-4 flex flex-col justify-between leading-normal">
                    <div class="mb-8">
                        <div class="text-white font-bold text-xl mb-2">
                            <a class="hover:text-orange" href="../../../../../Desktop/grade_layout/article.html">Парадигма
                                просветляет архетип</a>
                        </div>
                        <p class="text-gray-300 text-base">
                            <a class="hover:text-orange" href="../../../../../Desktop/grade_layout/article.html">Парадигма
                                просветляет архетип, таким образом, стратегия поведения, выгодная отдельному
                                человеку</a>
                        </p>
                    </div>
                    <div>
            ...
            <div class="w-full flex">
                <div class="h-48 lg:h-auto w-32 sm:w-60 lg:w-32 xl:w-48 flex-none text-center overflow-hidden">
                    <a class="block w-full h-full hover:opacity-75"
                       href="../../../../../Desktop/grade_layout/article.html"><img src="/assets/pictures/car_k900.png"
                                                                                    class="bg-white bg-opacity-25 w-full h-full  object-contain"
                                                                                    alt=""></a>
                </div>
                <div class="px-4 flex flex-col justify-between leading-normal">
            ...
            <div class="w-full flex">
                <div class="h-48 lg:h-auto w-32 sm:w-60 lg:w-32 xl:w-48 flex-none text-center overflow-hidden">
                    <a class="block w-full h-full hover:opacity-75"
                       href="../../../../../Desktop/grade_layout/article.html"><img src="/assets/pictures/car_soul.png"
                                                                                    class="bg-white bg-opacity-25 w-full h-full  object-contain"
                                                                                    alt=""></a>
                </div>
                <div class="px-4 flex flex-col justify-between leading-normal">
