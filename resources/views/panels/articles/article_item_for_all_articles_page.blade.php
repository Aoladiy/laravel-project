<div class="w-full flex">
    <div class="h-48 lg:h-auto w-32 sm:w-60 lg:w-32 xl:w-48 flex-none text-center overflow-hidden">
        <a class="block w-full h-full hover:opacity-75" href="../../../../../Desktop/grade_layout/article.html"><img
    ...
    <div class="px-4 leading-normal">
        <div class="mb-8 space-y-2">
            <div class="text-black font-bold text-xl">
                <a class="hover:text-orange" href="../../../../../Desktop/grade_layout/article.html">{{$article->title}}</a>
            </div>
            <p class="text-gray-600 text-base">
                <a class="hover:text-orange" href="../../../../../Desktop/grade_layout/article.html">{{$article->description}}</a>
            </p>
            <div>
